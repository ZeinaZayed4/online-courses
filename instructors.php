            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        ...
                        <p class="description">Nulla facilisi morbi tempus iaculis urna id volutpat lacus laoreet
                            non curabitur gravida.</p>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        ...
                        <p class="description">Mauris blandit aliquet elit eget tincidunt nibh pulvinar a proin
                            gravida hendrerit lectus.</p>
                        <div class="stats-grid">
                            <div class="stat">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="450">
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        ...
                        <p class="description">Donec rutrum congue leo eget malesuada vestibulum ac diam sit amet
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        ...
                        <p class="description">Sed porttitor lectus nibh cras ultricies ligula sed magna dictum
                            porta lorem ipsum dolor.</p>
                        <div class="stats-grid">
                            <div class="stat">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="550">
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        ...
                        <p class="description">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices
